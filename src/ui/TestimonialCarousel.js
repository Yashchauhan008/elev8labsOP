...
const TestimonialCarousel = ({testimonials}) => {
  ...
  return (
    <div className="relative w-full max-w-3xl px-4 py-12 mx-auto overflow-hidden">
      {/* Background gradient */}
      <div className="absolute inset-0 bg-transparent opacity-50 rounded-2xl -z-10"></div>
      {/* Decorative circles */}
      <motion.div 
      ...
      {/* Header */}
      <div className="text-center mb-10 font-[tenali]">
        <motion.h2 
      ...
      <div className="relative mx-auto max-w-2xl bg-slate-800 bg-opacity-40 backdrop-blur-sm rounded-[50px] p-8 shadow-xl">
        ...
        <AnimatePresence custom={direction} mode="wait">
          ...
          >
            ...
            >
              ...
              <div className="ml-4">
                <p className="text-white font-[tenali] text-3xl translate-y-1 font-semibold">{testimonials[currentIndex].name}</p>
